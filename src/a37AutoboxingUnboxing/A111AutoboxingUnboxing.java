package a37AutoboxingUnboxing;

/**
 *
 * @author Panzer01
 */
public class A111AutoboxingUnboxing {
    public static void main(String[] args) {

        //Autoboxing (se convierten de tipos primitivos a tipos Object(wrapper o clase envolvente))
